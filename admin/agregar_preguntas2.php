...
<div id="body" class="cuerpo">
  <?php include "header.php";  ?>
        <center><h1 style="margin-top: 20px; ">Nombre de la competencia: <?php echo $titulo; ?></h1>
        <button style="margin-bottom: 20px;" type="button" class="btn btn-primary float-right"data-toggle="modal" data-target="#exampleModalScrollable">+ Pregunta</button>
<?php 
...
while($datos = mysqli_fetch_array($consulta))
{
    ?>
    <tr>
    <td class="d-none"><?php echo $datos['id_pregunta'];?></td>
...
<a href="agregar_preguntas.php" ><button class="btn btn-primary">Regresar</button></a>
<br> <br>
...
<input type="hidden" name="titulo" id="titulo" value=" <?php echo $titulo; ?>">
        ...
        <div class="form-group">
            Titulo:
                 <input class="form-control" id="pregunta" name ="pregunta" type="text" required placeholder="Introduce el titulo">
         </div>
...
<div class="modal fade" id="exampleModalScrollable2" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
       <center><h5 class="modal-title" id="exampleModalScrollableTitle">Modificar</h5></center> 
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>  
...
<div class="modal fade" id="exampleModalScrollable3" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
       <center><h5 class="modal-title" id="exampleModalScrollableTitle">Eliminar </h5></center> 
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>  
      <form action="eliminar_pregunta.php" method="POST">
      <div class="modal-body">
    <input type="hidden" name="id_encuesta" id="id_encuesta" value=" <?php echo $id_encuesta; ?>">
<input type="hidden" name="titulo" id="titulo" value=" <?php echo $titulo; ?>">
