...
<link href="https://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet">
  <script src="../librerias/jquery/jquery-3.1.1.min.js"></script>
	...
	<title>Eliminación de resultados</title>
</head>
<body>
    <div id="icono"></div>
...
<div>
  <div class="col-md-7 text-justify border">
    ...
    <p class="lead">¿Estas seguro de eliminar todos los datos recabados con las evaluaciones?</p>
...
<div>
  <div class="col-md-7 text-justify border">
    ...
    <p class="lead">Te sugerimos que realizes una copia de la base de datos descargando los archivos pdf de las evaluaciones existentes, ya que una vez borrados no se pueden recuperar.
</p>
...
<br>
    ...
    <a href="#"  ><button class="btn btn-danger eliminar">Eliminar</button></a>
...
<div class="modal fade" id="exampleModalScrollable3" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <form action="eliminar_todo.php" method="POST">
