...
//$consulta = mysqli_query ($conn,"SELECT DISTINCT area FROM competencia ORDER BY fecha ")
    //or die ("error al actualizar los datos");
$consulta = "SELECT DISTINCT area FROM competencia  WHERE id_company = '$id_company' ORDER BY fecha";
...
<div id="body" class="cuerpo">
    <?php include "../admin/header.php";  ?>
       <center> 
     <br>
    <h2>Resultados de competencias por áreas </h2>
   
    <form action="../pdf/reporte_trabajadores_area.php" method="post">
...
<button class='btn btn-primary ' >Filtrar reporte</button>
 ...
 while($datos = $resultado->fetch_array())
    ...
    echo "<a class='i' href='../grafica/barras_competencia.php?area=".$datos['area']."'>".$datos['area']."</a>";
    echo"<br>";
    echo "</li>";     
}
 echo "</ul>"; 
...
?>
<br><a target="_blank"  href='../pdf/reporte_competencia.php' ><button class='btn btn-primary '>Reporte general</button></a>
