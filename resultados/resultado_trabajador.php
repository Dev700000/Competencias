...
$consulta = mysqli_query ($conn,"SELECT DISTINCT id_subordinado  FROM respuestas WHERE id_company='$id_company' ORDER BY id_subordinado ")
  ...
  <?php include "../admin/header.php";  ?>
   ...
   <br>
    <h2>Trabajadores evaluados</h2>
               <form action="../pdf/reporte_trabajadores.php" method="post">
...
<button class='btn btn-primary ' >Filtrar reporte</button>
...

  {
    ...
    echo "<a class='i' href='../grafica/barras_trabajador.php?id_jefes=".$datos['id_subordinado']."'>".$i.": ".$datos1['nombre']." ".$datos1['ap']." ".$datos1['am']."</a>";
    echo"<br>";
    echo "</li>"; 
    $i++;    
}
 echo "</ul>"; 
 ?>
 <br><a target="_blank"  href='../pdf/reporte_trabajadores.php' ><button class='btn btn-primary '>Reporte general</button></a>
