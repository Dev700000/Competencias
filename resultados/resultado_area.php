...
$consulta = mysqli_query ($conn,"SELECT DISTINCT area FROM respuestas  WHERE id_company = '$id_company' ")or die ("error al actualizar los datos");
...
<button class='btn btn-primary ' >Filtrar reporte</button>
...

  {
    ...
    echo "<a class='i' href='../grafica/barras_area.php?area=".$datos['area']."'>".$datos['area']."</a>";
   // echo "<a href='../Highcharts/index.php?area=".$datos['area']."'>".$datos['area']."</a>";
    echo"<br>";
    echo "</li>";     
}
 echo "</ul>"; 
...
?>
<br><a target="_blank" href='../pdf/reporte_trabajadores_area.php' ><button class='btn btn-primary '>Reporte general</button></a>
