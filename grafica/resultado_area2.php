...
error_reporting(1);
$area = $_GET['area'];
$consulta = mysqli_query ($conn,"SELECT * FROM respuestas_areas WHERE area = '$area' AND id_company='$id_company'")
or die ("error al actualizar los datos");
$sql="SELECT nombre,promedio FROM respuestas_areas WHERE area = '$area' AND id_company='$id_company'";
$sql1="SELECT SUM(promedio) as total FROM respuestas_areas WHERE area = '$area' AND id_company='$id_company'";
...
echo $sumar['total'];*/
	...
	// las buenas practicas dicen que el if solo se ocupa para un si o no, para mas opciones se utiliza el switch 
	/* if ($res <=20){
...
<center><h1>Resultados del área <?php echo $area; ?></h1>
	...
	<?php 
		//condicion por que en evaluador tamibien muestro esta vista
