...
$consulta = mysqli_query ($conn,"SELECT * FROM respuestas_generales WHERE id_company='$id_company'")
...
<link href="https://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet">
	...
	<title>Resultados general</title>
	<style type="text/css">
	.cursor{
		cursor: pointer;
	}
...
<div id="body" class="cuerpo">
	...
	<center><h1>Resultados Generales</h1>
		<br>
		<h5>Promedio General<?php echo " ".round($res,1)." ".$resultado1; ?></h5>
	<div class="container">
